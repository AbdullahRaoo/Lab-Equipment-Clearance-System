        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div className="flex justify-between items-start">
                    ...
                    <span className="bg-[#7d2628] text-white px-3 py-1 rounded-full text-sm font-medium shadow-sm">
                        Student Portal
                    </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {LABS_LIST.map((lab) => (
                        <Link
                            ...
                            className="group bg-white p-5 rounded-lg border border-gray-200 hover:border-[#7d2628] hover:shadow-md transition-all duration-200"
                        >
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{lab.code}</span>
                                <svg className="w-5 h-5 text-gray-300 group-hover:text-[#7d2628] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                </svg>
                            </div>
                            <h4 className="font-bold text-gray-900 text-lg group-hover:text-[#7d2628] transition-colors">
                                {lab.name}
                            </h4>
