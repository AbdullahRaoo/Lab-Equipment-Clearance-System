...
export default async function AllInventoryPage() {
    ...
    // Only admins can see all inventory
    if (!isAdmin) {
        redirect('/inventory');
    }
        ...
        <div className="p-8 space-y-6">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Viewing equipment from all laboratories</p>
                    </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                    <h2 className="text-lg font-semibold text-gray-900">All Equipment</h2>
                    <p className="text-sm text-gray-500">{stats.total} items across all labs</p>
                </div>
