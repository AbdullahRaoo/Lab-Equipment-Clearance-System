...
export default async function Lab4Page() {
  ...
  const { data: inventory, error: invError } = await getLabInventory('lab4');
  const { data: issues, error: issuesError } = await getLabIssues('lab4');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900">Lab 4 - Physics & Electronics Lab</h1>
            </div>
          </div>
        </div>
      </header>
