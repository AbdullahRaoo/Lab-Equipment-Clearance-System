...
export default async function Lab5Page() {
  ...
  const { data: inventory, error: invError } = await getLabInventory('lab5');
  const { data: issues, error: issuesError } = await getLabIssues('lab5');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900">Lab 5 - Computer & Networking Lab</h1>
            </div>
          </div>
        </div>
      </header>
