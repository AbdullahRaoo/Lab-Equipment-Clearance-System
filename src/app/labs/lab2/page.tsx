...
export default async function Lab2Page() {
  ...
  const inventoryResult = await getLabInventory('lab2');
  const borrowedResult = await getUserBorrowedEquipment('lab2', user.id);
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Lab 2 - Inventory</h1>
